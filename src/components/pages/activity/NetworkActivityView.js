...
var NetworkActivityStore = require('../../../stores/NetworkActivityStore');
var NetworkActivityActions = require('../../../actions/NetworkActivityActions');
...
var NetworkActivityView = React.createClass({
    ...
    componentWillMount: function() {
        ...
        NetworkActivityStore.addChangeListener(this._activityStoreChange)
    },

    componentDidMount: function() {

        NetworkActivityActions.load(this.state.page.details.asdf.id)
    ...
    _activityStoreChange:function() {

    }

});

module.exports = NetworkActivityView;